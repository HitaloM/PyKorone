...
CHATBOT_TOOLS = [MemoryAgentTool(), duckduckgo_search_tool(), notes_list_ai_tool()]
...
async def ai_chatbot_reply(message: Message, connection: ChatConnection, user_text: str | None):
    """
    ...
    system_prompt = Doc(_("You can use DuckDuckGo to search for information. Include information sources as links."))
    if memory_lines:
