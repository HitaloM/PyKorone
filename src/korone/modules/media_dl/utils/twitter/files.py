...
class TwitterFileUtils:
    ...
    async def save_binary_io(binary_io) -> str:
        output_file_path = TwitterFileUtils.generate_random_file_path(ORIGINAL_VIDEO_PREFIX)
    ...
    async def add_silent_audio(video_path: str) -> str:
        output_file_path = TwitterFileUtils.generate_random_file_path(
