...
_PyKorone_ is licensed under the [GNU Affero General Public License v3.0 (AGPLv3)](/LICENSE), a free software license approved by the [Free Software Foundation](https://www.fsf.org/) and the [Open Source Initiative](https://opensource.org/). Learn more about the AGPLv3 [here](https://www.gnu.org/licenses/agpl-3.0.html).
